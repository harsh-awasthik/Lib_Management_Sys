...
protected:
    string filename1 = "assets/student.csv";   
    string filename2 = "assets/books.csv";
    string filename3 = "assets/assigned.csv";
...
public:
    ...
    void AddBook(string bookname)
    {
        ...
        ofstream outfile(filename2, ios::app); // Open in append mode
    if (outfile.is_open()) {
